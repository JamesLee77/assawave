// ASSA WAVE 디자인 토큰 — index.css [data-theme] 변수의 TS 미러 (Portal).
//
// 용도: 런타임 SVG/차트가 색을 JS 값으로 읽을 때 사용.
...
const LIGHT: Tokens = {
  ...
  // Legacy mappings
  moss: "#1f9d57",   // Maps to positive
  moss2: "#34d399",
  clay: "#b45309",   // Maps to warning
  sky: "#2f7d8c",
};
...
const DARK: Tokens = {
  ...
  // Legacy mappings
  moss: "#34d399",   // Maps to positive
  moss2: "#a7f3d0",
  clay: "#fbbf24",   // Maps to warning
  sky: "#14e2e2",
};
